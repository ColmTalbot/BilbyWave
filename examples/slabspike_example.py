...
waveform_arguments = dict(waveform_approximant='IMRPhenomPv3HM',
...
prior_file = "double_wavelet_spikeslab.prior"
...
priors = bilby.core.prior.ConditionalPriorDict(priors)
...
for ii in range(n_wavelets):
    if ii == 0:
        wavelet_params = ['q_factor', 'centre_frequency', 'amplitude', 'beta']
    else:
